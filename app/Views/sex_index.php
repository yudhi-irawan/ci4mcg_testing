...
<?= $this->section('page-content'); ?>
	...
	<h1 class="mt-2">Tabel Sex</h1>
	<a href="/sex/create_one" class="btn btn-success mt-3" data-toggle="tooltip" data-placement="bottom" title="add data"><i class="glyphicon glyphicon-plus"></i> Add </a>
	<a href="/sex/generatepdf" class="btn btn-info mt-3" data-toggle="tooltip" data-placement="bottom" title=""> Download PDF </a>
	...
	<table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				...
				<th scope="col">Sex ID</th>
				<th scope="col">Sex Description</th>
			</tr>
		</thead>
		<tbody>
			<?php $i = 1; ?>
			<?php foreach ($sex as $k) : ?>
				<tr>
					<th scope="row"><?= $i++; ?></th>
					<td>
						<a href="/sex/edit_one/<?= $k['sex_id']; ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="edit"><i class="glyphicon glyphicon-edit"></i></a>
						<a href="#" data-href="<?= base_url('sex/delete_one/'.$k['sex_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="delete"><i class="glyphicon glyphicon-remove"></i></a>
					</td>
					<td><?= $k['sex_id']; ?></td>
					<td><?= $k['sex_desc']; ?></td>
				</tr>
