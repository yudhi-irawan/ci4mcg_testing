...
<?= $this->section('page-content'); ?>
	...
	<a href="/emp/create_one" class="btn btn-success mt-3" data-toggle="tooltip" data-placement="bottom" title="add data"><i class="glyphicon glyphicon-plus"></i> Add </a>
	<a href="/emp/generatepdf" class="btn btn-info mt-3" data-toggle="tooltip" data-placement="bottom" title=""> Download PDF </a>
		...
		<tbody>
			...
			<?php foreach ($emp as $k) : ?>
				<tr>
					<th scope="row"><?= $i++; ?></th>
					<td>
						<a href="/emp/edit_one/<?= $k['emp_id']; ?>" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="bottom" title="edit"><i class="glyphicon glyphicon-edit"></i></a>
						<a href="#" data-href="<?= base_url('emp/delete_one/'.$k['emp_id']) ?>" onclick="confirmToDelete(this)" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="bottom" title="delete"><i class="glyphicon glyphicon-remove"></i></a>
					</td>
					<td><?= $k['emp_id']; ?></td>
					<td><?= $k['emp_name']; ?></td>
					<td><?= $k['emp_bday']; ?></td>
